    ...
    <Card className={Style.card} style={{ height: "750px" }}>
      {displayOne ? (
        <DisplayOneProduct
          ...
          picUrl={productToDisplay.imageURLs[0]}
          price={productToDisplay.price}
          chip={productToDisplay.chip}
          memory={productToDisplay.memory}
          rating={productToDisplay.rating}
          packageDimensionsWidth={productToDisplay.packageDimensions.width}
          packageDimensionsHeight={productToDisplay.packageDimensions.height}
          packageDimensionsDepth={productToDisplay.packageDimensions.depth}
