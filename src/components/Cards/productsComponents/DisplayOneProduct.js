  ...
  return (
    <>
      <div style={{ height: "250px" }}>
        ...
        <br />
        <label>price: </label>
        <TextField inputRef={priceRef} size="small" type="text" value={price} />
        <br />
        <label>chip: </label>
        <TextField inputRef={chipRef} size="small" type="text" value={chip} />
        <br />
        <label>memory: </label>
        <TextField
          inputRef={memoryRef}
